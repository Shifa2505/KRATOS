...
class Phonetics:
	...
	def soundex (self):
		...
		#table = str.maketrans('abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', '0123012002245501262301020201230120022455012623010202')
		...
		# translate the str into soundex code according to the table above
	...
	def caverphone (self):
		...
		# for singleLetter in ["s", "t", "p", "k", "f", "m", "n"]:
            ...
            # print(otherParts)
			# code = str.join(str(otherParts), str.upper(singleLetter))
